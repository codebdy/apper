...
export const EntityTree = memo((props: { graph?: Graph }) => {
  ...
  const getModelPackageNodes = useCallback(() => {
    ...
    return packages.map((pkg) => {
      return {
        ...
        key: pkg.uuid,
        icon: pkg.sharable
          ? <svg style={{ width: 16, height: 16 }} fill="currentColor" viewBox="0 0 1024 1024">
  ...
  const treeData: DataNode[] = useMemo(() => [
    ...
    },
    {
      icon: <SvgIcon>
        <svg style={{ width: "16px", height: "16px" }} viewBox="0 0 1024 1024" fill="currentColor">
          <path d="M858.4 885.7H603.1c-35.2 0-63.8-28.7-63.8-63.8V603.1c0-35.2 28.7-63.8 63.8-63.8h218.7c35.2 0 63.8 28.7 63.8 63.8V749c0 15.1-12.3 27.3-27.3 27.3-15.1 0-27.3-12.3-27.3-27.3V603.1c0-5-4.1-9.1-9.1-9.1H603.1c-5 0-9.1 4.1-9.1 9.1v218.7c0 5 4.1 9.1 9.1 9.1h255.2c15.1 0 27.3 12.3 27.3 27.3 0.1 15.2-12.2 27.5-27.2 27.5zM420.9 885.7H202.2c-35.2 0-63.8-28.7-63.8-63.8V603.1c0-35.2 28.7-63.8 63.8-63.8h218.7c35.2 0 63.8 28.7 63.8 63.8v218.7c0 35.2-28.7 63.9-63.8 63.9zM202.2 594c-5 0-9.1 4.1-9.1 9.1v218.7c0 5 4.1 9.1 9.1 9.1h218.7c5 0 9.1-4.1 9.1-9.1V603.1c0-5-4.1-9.1-9.1-9.1H202.2zM821.8 484.7H603.1c-35.2 0-63.8-28.7-63.8-63.8V202.2c0-35.2 28.7-63.8 63.8-63.8h218.7c35.2 0 63.8 28.7 63.8 63.8v218.7c0.1 35.1-28.6 63.8-63.8 63.8zM603.1 193c-5 0-9.1 4.1-9.1 9.1v218.7c0 5 4.1 9.1 9.1 9.1h218.7c5 0 9.1-4.1 9.1-9.1V202.2c0-5-4.1-9.1-9.1-9.1H603.1zM457.3 484.7H202.2c-35.2 0-63.8-28.7-63.8-63.8V202.2c0-35.2 28.7-63.8 63.8-63.8h218.7c35.2 0 63.8 28.7 63.8 63.8V348c0 15.1-12.3 27.3-27.3 27.3-15.1 0-27.3-12.3-27.3-27.3V202.2c0-5-4.1-9.1-9.1-9.1H202.2c-5 0-9.1 4.1-9.1 9.1v218.7c0 5 4.1 9.1 9.1 9.1h255.2c15.1 0 27.3 12.3 27.3 27.3 0 15.1-12.3 27.4-27.4 27.4z"></path>
        </svg>
      </SvgIcon>,
      title:
